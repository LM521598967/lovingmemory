...
<ul class="fa-ulist">
    ...
    <li class="fa-list fa-icon">Exit music: New Wine</li><li class="fa-list fa-icon">Something or other</li>
</ul>
<h2>Crematorium <span class="highlight">1:00pm</span></h2>
<ul class="fa-ulist">
